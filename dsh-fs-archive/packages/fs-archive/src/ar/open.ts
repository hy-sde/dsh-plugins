...
import { ARCHIVE_EXTENSION_ALTERNATION, archiveFormatFromPath, formatReaderFor } from './registry.ts'
import { type ByteSource, fileByteSource, memoryByteSource } from './source.ts'
import type {
