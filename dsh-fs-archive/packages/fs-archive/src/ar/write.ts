...
import { encodeAsar } from './asar.ts'
import { gzipCompress } from './codecs/gzip.ts'
import { zstdCompress } from './codecs/zstd.ts'
import { memberContentToBytes } from './open.ts'
import { encodeTar } from './tar.ts'
import type { ArchiveFormat, ArchiveMemberContent, WritableArchiveFormat } from './types.ts'
import { encodeZip } from './zip.ts'
...
export async function writeArchive(
  ...
  await fs.writeFile(destPath, await encodeArchive(format, entries))
}
