...
// CRC-64/XZ and CRC-16/ARC are table-driven so format modules never hand-roll
// per-bit loops. Format-owned oddballs (bzip2's MSB-first CRC-32, CAB's block
// checksum, cpio/tar sums) stay in their modules.
