...
import { crc16Arc, crc32, crc64 } from '../src/ar/checksums.ts'

// Containers store these exact values on the wire; if any of them drifts
// (e.g. crc32 seed semantics stop matching zlib chaining), every archive CRC
// verification in ar/ starts rejecting valid archives.
