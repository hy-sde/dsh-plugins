import { sanitizeDiagnosticText } from '../platform/diagnostics.ts'
import { ensureDomGlobals } from './dom-shim.ts'
import { extractMermaidFences, type MermaidFence } from './fences.ts'
