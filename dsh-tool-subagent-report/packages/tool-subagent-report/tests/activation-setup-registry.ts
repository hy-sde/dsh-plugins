 ...
 * child's unpublished creation context. Ported verbatim (imports adapted) from
 * `@deepseek-ai/dsh-subagent`
 * (`packages/subagent/subagent/src/activation-setup-registry.ts`) — MIT, see
 * THIRD-PARTY-NOTICES.md — because the fork-only continuation channel is what
 * this package's test suite exercises.
 *
 * @module @hy-sde-org/dsh-tool-subagent-report/tests/activation-setup-registry
 */
