/**
 * Package-owned invariant companion for `@hy-sde-org/dsh-tool-browser`.
 * @module @hy-sde-org/dsh-tool-browser/invariant
 */
...
const PACKAGE_NAME = '@hy-sde-org/dsh-tool-browser'
