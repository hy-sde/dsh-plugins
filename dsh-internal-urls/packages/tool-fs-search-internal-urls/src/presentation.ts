 ...
 * model-facing render consumes ({@link module:@hy-sde-org/dsh-tool-fs-search-internal-urls/search-core}
 ...
 *
 * @module @hy-sde-org/dsh-tool-fs-search-internal-urls/presentation
 */
 ...
 * ({@link module:@hy-sde-org/dsh-tool-fs-search-internal-urls/grep} `formatGrepMatches`), so
