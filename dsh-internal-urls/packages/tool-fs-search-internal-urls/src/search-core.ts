 ...
 *
 * @module @hy-sde-org/dsh-tool-fs-search-internal-urls/search-core
 */
 ...
 * retention pass both the model-facing render ({@link module:@hy-sde-org/dsh-tool-fs-search-internal-urls/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@hy-sde-org/dsh-tool-fs-search-internal-urls/presentation} `grepSearchMeta`)
